export type data_type = {
	fakeUser: {
		keldar: {
			id: 'keldar';
			name: 'Keldar';
			picture: 'https://cdn.discordapp.com/attachments/1130197336543461457/1173950520642256916/kharon_03.jpg';
			life: {
				currentLife: 100;
				maxLife: 100;
			};
			message: 'Justice sera faite !';
			spells: {
				benedictionDeKeldar: {
	...
	pages: {
		home: {
			title: 'Bienvenu sur BuffTimer';
			articles: {
				whatIsBuffTimer: {
					id: 'whatIsBuffTimer';
					title: "Qu'est-ce que 'BuffTimer' ?";
					article: "C'est une application pour visualiser facilement quel Buff est actif et sur qui. Il permet aussi de connaître l'état de santé des joueurs ainsi que leurs besoins.";
				};
			};
		};
	};
