				...
				<div className={styles.arene}>
					<div className={styles.arene_team}>
						...
						{data.characters.map((character) => (
							<div className={styles.arene_team_character}>
								<CharacterCard key={`${character.character.id}_character`} character={character.character} />
								{character.character.id !== data.characters[0].character.id && (
									<svg onClick={() => handleDelete(character.group_characters_id)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
